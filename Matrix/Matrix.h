...
//  Test_File
//
//  Created by Mitchell Tanbun on 24/8/19.
//  Copyright (c) 2019 Mitchell Tanbun. All rights reserved.
//

#ifndef __Test_File__Matrix__
#define __Test_File__Matrix__
...
double* parser(const std::string& input);

#endif /* defined(__Test_File__Matrix__) */
